...
export const mockProducts: Product[] = [
  // Hair
  { id: 'shampoo', name: { UA: 'Шампунь', DE: 'Shampoo', EN: 'Shampoo' }, price: 18, category: 'hair', image: 'https://images.unsplash.com/photo-1585232004423-244e0e6904e3?w=300&h=300&fit=crop' },
  { id: 'conditioner', name: { UA: 'Кондиціонер', DE: 'Conditioner', EN: 'Conditioner' }, price: 22, category: 'hair', image: 'https://images.unsplash.com/photo-1535585209827-a15fcdbc4c2d?w=300&h=300&fit=crop' },
  { id: 'hair_mask', name: { UA: 'Маска для волосся', DE: 'Haarmaske', EN: 'Hair Mask' }, price: 28, category: 'hair', image: 'https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?w=300&h=300&fit=crop' },
  ...
  // Makeup
  { id: 'micellar', name: { UA: 'Міцелярна вода', DE: 'Mizellenwasser', EN: 'Micellar Water' }, price: 16, category: 'makeup', image: 'https://images.unsplash.com/photo-1556228578-0d85b1a4d571?w=300&h=300&fit=crop' },
  ...
  { id: 'warming_cream', name: { UA: 'Розігріваючий крем', DE: 'Wärmecreme', EN: 'Warming Cream' }, price: 26, category: 'massage', image: 'https://images.unsplash.com/photo-1570194065650-d99fb4b38b17?w=300&h=300&fit=crop' },
