          ...
          >
            {products.map((product, i) => {
              ...
              return (
                <div
                  key={product.id}
                  className="shrink-0 w-[180px] tile-luxury flex flex-col items-center justify-center gap-3 rounded-2xl px-3 py-8 sm:py-12 md:py-16"
                  style={{ scrollSnapAlign: 'center' }}
                >
                  <p className="min-h-[2rem] text-center text-sm font-medium text-foreground">{product.name[language]}</p>
                  <p className="text-sm font-semibold text-gold">{product.price} {t('currency')}</p>
